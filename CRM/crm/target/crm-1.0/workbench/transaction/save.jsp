			...
			$("#create-customerName").typeahead({
				source: function (query, process) {
					$.get(
							...
							{ "name" : query },
							function (data) {
								//data	[{客户1},{2},{3}] (要返回String，下面的process方法才能识别，后台查询数据返回String)
								//alert(data);
								process(data);
							},
							"json"
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="0234cb737f29436d90e2cc6fe8daba9b" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="e59a9ac13a384be590502499ca369c69 " name="contactsId">
			</div>
		</div>
