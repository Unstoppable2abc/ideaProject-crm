...
<script type="text/javascript">
	...
	function changeIcon(stage, index1) {
		...
		//如果当前阶段的可能性为0，则前7个一定是黑圈，后两个一个是红叉，一个是黑叉
		if(currentPossibility === "0"){
			...
			//如果当前阶段的可能性不为0，则后两个是黑叉，前7个可能是绿圈，绿色标志，黑圈
		}else {
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			<%
				...
				//如果当前阶段的可能性不为0，则前7个可能是绿圈，绿色标记，黑圈，后两个一定是黑叉
			}else {
			...
			%>
						...
						-----------
			<%
						//如果遍历出来的阶段可能性不为0，前7个可能是绿圈，绿色标记，黑圈
					}else {
